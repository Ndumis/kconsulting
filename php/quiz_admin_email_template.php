    ...
    <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,0.08);max-width:600px;">
      ...
      <tr>
        <td style="background:#0a0a0a;padding:32px 40px;text-align:center;">
          <p style="color:#d4a843;font-size:0.75rem;font-weight:700;letter-spacing:3px;margin:0 0 8px;">NEW QUIZ LEAD</p>
      ...
      <tr>
        <td style="padding:28px 40px 0;text-align:center;">
          <div style="display:inline-block;background:#f9f6ee;border:2px solid #d4a843;border-radius:8px;padding:12px 28px;">
          ...
          <table width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr style="background:#f9f9f9;">
              ...
              <td style="padding:8px 0;color:#0a0a0a;font-size:0.9rem;">
                <a href="mailto:<?= htmlspecialchars($d['email']) ?>" style="color:#d4a843;text-decoration:none;"><?= htmlspecialchars($d['email']) ?></a>
              </td>
            </tr>
            <tr>
      ...
      <tr>
        <td style="padding:24px 40px;">
          ...
          <div style="background:#f9f6ee;border-left:4px solid #d4a843;padding:14px 18px;border-radius:0 8px 8px 0;">
      ...
      <tr>
        <td style="padding:0 40px 36px;text-align:center;">
          ...
          <?php if (!empty($d['phone'])): ?>
          <a href="tel:<?= htmlspecialchars($d['phone']) ?>" style="display:inline-block;background:#d4a843;color:#0a0a0a;text-decoration:none;padding:13px 28px;border-radius:8px;font-weight:600;font-size:0.88rem;margin:0 6px 8px;">Call Now</a>
          <?php endif; ?>
        </td>
      </tr>
